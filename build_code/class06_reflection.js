...
import { Reflector } from 'https://cdn.jsdelivr.net/npm/three@0.166.0/examples/jsm/objects/Reflector.js';
...
function init() {
	...
	loader.load('scene.gltf', async function (gltf) {
		...
		// --- Add a planar reflector as the ground ---
		const width = 5;
		const height = 5;
		...
		reflector.position.y = -size.y * scale * 0.5;
		scene.add(reflector);
